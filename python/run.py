...
def main():
    ...
    Path("../shared/plugins").mkdir(parents=True, exist_ok=True)
    ...
    print("\n" + "="*50)
    print("🎉 GoNote is running!")
    print("="*50)
    print(f"\n📝 Open your browser to: http://localhost:{port}")
    print("\n💡 Tips:")
    print("   - Press Ctrl+C to stop the server")
    print("   - Your notes are in ./data/")
    print("   - Plugins go in ./shared/plugins/")
